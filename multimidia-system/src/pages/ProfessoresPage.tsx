      ...
      <main className="flex-grow">
        <div className="container mx-auto px-2 sm:px-4 py-8 max-w-4xl">
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-blue-900">Professores - Contato</h1>
          ...
          <section className="mb-10">
            <div className="mb-2 text-blue-900 font-semibold text-base text-center">
              Professores Efetivos
            </div>
            <div className="overflow-x-auto">
              <table className="w-full bg-white rounded-xl shadow border border-gray-200 text-gray-800 text-xs sm:text-base">
                <thead>
          ...
          {professores.substitutos && professores.substitutos.length > 0 && (
            <section className="mb-10">
              <div className="mb-2 text-blue-900 font-semibold text-base text-center">
                Professores Substitutos
              </div>
              <div className="overflow-x-auto">
                <table className="w-full bg-white rounded-xl shadow border border-gray-200 text-gray-800 text-xs sm:text-base">
                  ...
                  <tbody>
                    {professores.substitutos.map((prof, idx) => (
                      <tr key={prof.email} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                        <td className="p-3">{prof.nome}</td>
                        <td className="p-3">
                          <a
